...
export default function Home() {
  return (
    ...
    <li>It is possible for a user to customize the news aggregator app in relation to their preferred news topics, such as world economics, sports, or politics, according to the interest that they have.</li>
    </ul>
